...
class Classify(object):
    ...
    def __call__(self, context=None):
        items = (
            SimpleTerm(value='01', title=_(u'Directory')),
            SimpleTerm(value='02', title=_(u'Library')),
            SimpleTerm(value='03', title=_(u'Literature')),
            SimpleTerm(value='04', title=_(u'Database')),
            SimpleTerm(value='05', title=_(u'Newspaper')),
            SimpleTerm(value='06', title=_(u'Journal')),
            SimpleTerm(value='07', title=_(u'Institute'))
        )
        return SimpleVocabulary(items)
